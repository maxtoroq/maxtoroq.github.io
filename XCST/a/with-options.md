...
<div class="ref-element-syntax language-xml highlighter-rouge"><pre class="highlight"><code><span class="nt">&lt;a:with-options</span>
  ...
  <span>options</span>? = <i title="Expression.">expression</i>(<a href="{{ page.bcl_url }}9eekhta0" title="System.Collections.Generic.IEnumerable">IEnumerable</a>&lt;<span title="System.Web.Mvc.SelectListItem">SelectListItem</span>&gt;) &gt;
  &lt;!-- Content: <span><a href="option.html">a:option</a>*</span> --&gt;
<span class="nt">&lt;/a:with-options&gt;</span></code></pre></div>
<p>Defines options for a model's member form control.</p>
<dl>
