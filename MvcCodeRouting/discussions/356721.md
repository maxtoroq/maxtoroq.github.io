...
<p>As you already know, you can use the <a href="https://github.com/maxtoroq/MvcCodeRouting/tree/master/docs/Route-Formatting.md">RouteFormatter</a>&nbsp;setting to hyphenate both controller and action segments, but this doesn't change the actual controller and action names.</p>
