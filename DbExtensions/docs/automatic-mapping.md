...
<div class="note">Numbers only have meaning relative to each other. For instance, instead of using 1 and 2, you can use 0 and 1, 100 and 200, or -68 and 17. It's the *number of numeric column names* which determines what constructor to use (number of parameters), and the arguments are passed in *numeric column order*.</div>
