...
```
[SqlSet]({{ site.github.repository_url }}/blob/master/docs/SqlSet.md) provides a LINQish API for making queries, but using SQL instead of lambda expressions. The above code executes the following queries:
...
```
With [SqlBuilder]({{ site.github.repository_url }}/blob/master/docs/SqlBuilder.md) you have complete control of the executing SQL.
